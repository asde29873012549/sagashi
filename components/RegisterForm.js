...
export default function RegisterForm() {
	return (
		<div className="hidden">
			<Tabs defaultValue="login" className="fixed z-20 inset-0 m-auto w-9/12 h-4/6 max-w-max max-h-max min-w-fit">
				...
				<TabsContent value="login">
					<Card className="h-4/6 w-9/12 max-w-max max-h-max min-w-fit">
						...
						<CardFooter className="flex flex-col">
							<Button variant="outline" className="w-full mb-2">Sign in With Google</Button>
					...
					<Card className="h-4/6">
						...
						<CardContent>
							...
							<div className="space-y-1 md:mb-6">
								...
								<Input id="email" placeholder="yourEmail@example.com" className="w-80"/>
							</div>
						</CardContent>
						<CardFooter>
