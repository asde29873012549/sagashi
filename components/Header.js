	...
	return (
		<Fragment>
			<div className="relative flex h-1/4 w-full items-center justify-center md:px-9 md:justify-between md:py-6 sm:px-6 sm:py-4 px-3 py-2">
				<MenuBar/>
				<div className="md:w-1/4 md:h-12 text-3xl font-bold inline-block md:text-5xl sm:text-3xl hover:cursor-pointer">CACTUS</div>
				...
				<div className="fixed z-[11] bg-background bottom-0 w-full flex justify-around items-center px-5 py-3 md:relative md:w-1/4 md:flex md:justify-end md:text-md">
